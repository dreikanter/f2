...
urls = [
  ...
  "http://127.1/", "http://0/", "http://[0::0]/", "http://127.0.0.1./",
  "http://[::ffff:127.0.0.1]/", "http://[::ffff:169.254.169.254]/",
  "http://[fc00::1]/", "http://[fd00::1]/", "http://[fe80::1]/",
  "http://127.0.0.1/", "http://169.254.169.254/",
  "https://cdn.example.com/ok.png", "https://10.example.com/", "https://localhost.example.com/",
  "https://example.com/", "https://xn--r8jz45g.jp/img.png", "https://user:pass@example.com/",
]
urls.each { |u| puts format("%-34s safe?=%s", u, PublicUrl.safe?(u)) }
