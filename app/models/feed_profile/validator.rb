class FeedProfile
  # Validates the shape of every entry in FeedProfile::PROFILES.
  # Invoked at boot from config/initializers/feed_profile_validator.rb so
  # registry typos surface immediately instead of at runtime.
  #
