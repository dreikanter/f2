class Development::SystemStatusController < ApplicationController
  ...
  def config_checks
    [
      credential_check("resend_key", "Resend key present", :resend, :api_key),
      credential_check("resend_signing_secret", "Resend signing secret present", :resend, :signing_secret),
