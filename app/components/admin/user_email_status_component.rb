class Admin::UserEmailStatusComponent < ViewComponent::Base
  ...
  VIEW_EVENTS_CLASSES = "inline-flex items-center justify-center whitespace-nowrap rounded-md border border-border bg-surface px-4 py-2 text-base font-semibold text-body shadow-sm transition hover:bg-surface-muted focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-1".freeze
