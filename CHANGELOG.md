...
- AI previews and feed activity now show when AI returned no posts or candidates were already published.
...
- Show event status, job run details, and email preview descriptions in their page headers.
...
- Feed stats now show a subscriber count when it's available.
...
- Fixed the feed preview button not reopening the preview after you closed it once.
