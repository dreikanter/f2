...
- Choosing between following a feed or following with AI on the new-feed page now uses tabs, so each option gets its own address you can bookmark or share.
