...
class Onboarding::AccessTokenValidationsControllerTest < ActionDispatch::IntegrationTest
    def user
    ...
    test "should validate token successfully" do
      ...
      FreefeedClient.stub :new, mock_client do
        post onboarding_access_token_validations_path, params: {
          token: "valid_token",
    ...
    test "should handle missing token parameter" do
      ...
      assert_response :unprocessable_entity
      assert_match "Token and host are required", response.body
    end
