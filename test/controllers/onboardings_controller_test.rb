...
class OnboardingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should show intro page when authenticated and onboarding exists" do
    sign_in_as(user)
    get onboarding_intro_url
  ...
  test "should require authentication to access intro" do
    get onboarding_intro_url
  ...
  test "should show intro step" do
    sign_in_as(user)
    get onboarding_intro_url
    assert_response :success
  ...
  test "should show token step" do
    sign_in_as(user)
    get onboarding_access_token_url
    assert_response :success
    assert_select "h1", "Connect Your FreeFeed Account"
  end

  test "should show feed step" do
    ...
    get onboarding_feed_url
    assert_response :success
  end

  test "should show outro step" do
    user_with_both = create(:user)
    access_token = create(:access_token, user: user_with_both)
    feed = create(:feed, user: user_with_both)
    onboarding = create(:onboarding, user: user_with_both, access_token: access_token, feed: feed)
