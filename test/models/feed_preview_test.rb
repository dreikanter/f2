...
class FeedPreviewTest < ActiveSupport::TestCase
  ...
  test ".digest_for should depend on the profile's declared options" do
    ...
    with_option = FeedPreview.digest_for("youtube", { "url" => "https://y.test", "exclude_shorts" => true })
  ...
  test ".digest_for should ignore option key order" do
    assert_equal FeedPreview.digest_for("youtube", { "url" => "https://y.test", "exclude_shorts" => true }),
                 FeedPreview.digest_for("youtube", { "exclude_shorts" => true, "url" => "https://y.test" })
  end
  ...
  test ".digest_for should ignore params the profile doesn't declare" do
    assert_equal FeedPreview.digest_for("youtube", { "url" => "https://y.test" }),
                 FeedPreview.digest_for("youtube", { "url" => "https://y.test", "derived" => "anything" })
  end
