...
class LlmProvider::OpenaiTest < ActiveSupport::TestCase
  ...
  test "#limit_tool_calls should configure Responses requests and preserve other options" do
    ...
    chat.with_provider_options(service_tier: "default", max_tool_calls: 99)
    client.limit_tool_calls(chat, remaining: 2)
    payload = nil
