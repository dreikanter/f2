...
- [X] T014 Update `app/services/feed_details_fetcher.rb` to call new detector contract; persist `feed_details.candidates` and mirror recommended into existing `feed_profile_key`/`title` columns; tests in `test/services/feed_details_fetcher_test.rb`.
